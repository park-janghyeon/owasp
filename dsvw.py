...
# Define a whitelist of allowed external domains
ALLOWED_DOMAINS = ["example.com", "trustedsource.com"]

# Function to check if a domain is in the allowed list
        ...
        try:
            if path == '/':
                if "id" in params:
                    ...
                    url = params["path"]
                    # SSRF Defense: Block requests to non-whitelisted domains and internal IPs
